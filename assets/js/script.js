...
const musicData = [
  ...
  },
  {
    ...
    {
    backgroundImage: "./images/Biar Kucari Jalanku.jpg",
    posterUrl: "./images/Biar Kucari Jalanku.jpg",
    title: "Biar Kucari Jalanku",
    album: "Surat Untuk Kekasih",
    genre: "Indonesian Pop",
    artist: "Tommy J Pisa",
    musicPath: "Biar Kucari Jalanku.mp3",
  },
    {
  ...
  },
  {
    ...
    {
    backgroundImage: "./images/Hati Yang Luka.jpg",
    posterUrl: "./images/Hati Yang Luka.jpg",
    title: "Hati Yang Luka",
    album: "Hati Yang Luka",
    genre: "Indonesian Pop",
    artist: "Betharia Sonata",
    musicPath: "Hati Yang Luka.mp3",
  },
  {
  ...
  },
  {
    ...
    {
    backgroundImage: "./images/Selalu Ada di Nadimu (Original Soundtrack From JUMBO).jpg",
    posterUrl: "./images/Selalu Ada di Nadimu (Original Soundtrack From JUMBO).jpg",
    title: "Selalu Ada di Nadimu (Original Soundtrack From JUMBO)",
    album: "Selalu Ada di Nadimu (Original Soundtrack From JUMBO)",
    genre: "Indonesian Pop",
    artist: "Prince Poetiray, Quinn Salman",
    musicPath: "Selalu Ada di Nadimu (Original Soundtrack From JUMBO).mp3",
  },
  {
  ...
  },
  {
    ...
    musicPath: "Tak Ingin Sendiri.mp3",
  }, 
  {
